...
def main():
    ...
    # list_message = ListMessagesWithLabels(service,user_id="me", label_ids
    # message_json = json.loads(list_message[12])
    
    # get the table name

    # dynamodb = boto3.resource('dynamodb')
    # table = dynamodb.Table('forum_email_2')



    list_message = list_message[0:2000]
    ...
    for message_ids in list_message:
        ...
        # set the date format to ISO8601    
        
        # datestring = email_date 
        # datestring = re.sub("[\(\[].*?[\)\]]", "", datestring)
        # yourdate = dateutil.parser.parse(datestring)
        # yourdate = str(yourdate)
        # yourdate_1 = yourdate[0:19]
        # yourdate_2 = yourdate[19:]
        # yourdate_1 = re.sub(":","",yourdate_1)
        # yourdate_1 = re.sub("-","",yourdate_1)
        # yourdate_1 = re.sub(" ","T",yourdate_1)
        # yourdate_2 = re.sub(":","",yourdate_2)
        # yourdate = yourdate_1 + yourdate_2
        # # print(yourdate)   
        # email_date = yourdate               
        ...
        # myclient = pymongo.MongoClient("mongodb://kailuo:lk19931214@ds149030.mlab.com:49030/forum_email")
        # mydb = myclient["forum_email"]
        # mycol = mydb["basepostmodels"]
